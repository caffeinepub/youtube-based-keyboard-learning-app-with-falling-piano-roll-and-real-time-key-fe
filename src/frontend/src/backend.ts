...
import type { PracticeConfig as _PracticeConfig, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PracticeConfig]): PracticeConfig | null {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        practiceConfig: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.practiceConfig)),
        name: value.name
    };
}
...
function to_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        practiceConfig: value.practiceConfig ? candid_some(value.practiceConfig) : candid_none(),
        name: value.name
    };
}
